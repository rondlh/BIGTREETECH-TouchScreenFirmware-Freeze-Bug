...
#define GUI_DispStringInRect(x0, y0, x1, y1, c)       _Generic(((c + 0)), const uint8_t *: _GUI_DispStringInRect, \
                                                                                uint8_t *: _GUI_DispStringInRect, \
                                                                                  default: _GUI_DispLabelInRect)(x0, y0, x1, y1, c)
...
#define GUI_DispStringInRectEOL(x0, y0, x1, y1, c)    _Generic(((c + 0)), const uint8_t *: _GUI_DispStringInRectEOL, \
                                                                                uint8_t *: _GUI_DispStringInRectEOL, \
                                                                                  default: _GUI_DispLabelInRectEOL)(x0, y0, x1, y1, c)
